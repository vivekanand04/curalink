...
const PublicationsManage = () => {
  ...
  return (
    <div className="page-content publications-manage-page">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '15px' }}>
                <div style={{ display: 'flex', gap: '15px' }}>
                  <span className="action-link" onClick={() => handleViewPublication(pub)} aria-label="View">
                    <FiEye className="action-icon show-mobile" />
                    <span className="action-text show-desktop">View</span>
                  </span>
                  <span className="action-link" onClick={() => handleEdit(pub)} aria-label="Edit">
                    <FiEdit2 className="action-icon show-mobile" />
                    <span className="action-text show-desktop">Edit</span>
                  </span>
                  <span className="action-link" onClick={() => handleDelete(pub.id)} style={{ color: '#dc3545' }} aria-label="Delete">
                    <FiTrash2 className="action-icon show-mobile" />
                    <span className="action-text show-desktop">Delete</span>
                  </span>
                </div>
